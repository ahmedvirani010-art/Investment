"""
Bridge script: runs Crude Oil HMM regime detection and outputs JSON to stdout for Next.js API.
Usage: python scripts/api_crude_oil_hmm_regime.py [symbol] [--period 730d] [--interval 1d] [--n-components 7] [--last-n 500]
"""
import argparse
import json
import os
...
def main() -> None:
    ...
    parser.add_argument("symbol", nargs="?", default="CL=F", help="Crude oil symbol (default CL=F for WTI)")

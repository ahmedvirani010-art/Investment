"""
Bridge script: runs HMM regime detection and outputs JSON to stdout for Next.js API.
Usage: python scripts/api_hmm_regime.py [symbol] [--period 730d] [--interval 1h] [--n-components 7] [--last-n 500]
"""
import argparse
import json
import os
...
def main() -> None:
    ...
    parser.add_argument("symbol", nargs="?", default="BTC-USD", help="e.g. BTC-USD or LUCK.PK")

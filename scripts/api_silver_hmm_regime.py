"""
Bridge script: runs Silver HMM regime detection and outputs JSON to stdout for Next.js API.
Usage: python scripts/api_silver_hmm_regime.py [symbol] [--period 730d] [--interval 1d] [--n-components 7] [--last-n 500]
"""
import argparse
import json
import os
...
def main() -> None:
    ...
    parser.add_argument("symbol", nargs="?", default="SI=F", help="Silver symbol (default SI=F; use SLV for ETF)")

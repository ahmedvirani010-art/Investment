"""
Bridge script: runs NIKKEI HMM regime detection and outputs JSON to stdout for Next.js API.
Usage: python scripts/api_nikkei_hmm_regime.py [symbol] [--period 730d] [--interval 1d] [--n-components 7] [--last-n 500]
"""
import argparse
import json
import os
...
def main() -> None:
    ...
    parser.add_argument("symbol", nargs="?", default="^N225", help="NIKKEI symbol (default ^N225 for Nikkei 225)")
